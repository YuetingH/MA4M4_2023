...
[SupportClass1.ipynb](https://github.com/MA4M4_2023/Support_Class_1/SupportClass1.ipynb): This notebook is to give you simple examples of the types of packages you can use to represent networks and compute basic properties (e.g., NetWorkX, Numpy, Pandas). After this class, you should be able to:
